...
/** Main GUI for the VideoStore project
 *
...
public class GUI extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        setTitle("CPS122 Video Store Project");
        setResizable(false);
    ...
    {//GEN-HEADEREND:event_saveItemActionPerformed
        try
        {
            Main.getInstance().saveStoreDatabase();
        }
        catch(Exception e)
        {
    ...
    private GUI() 
    {
        ...
        dateCard = new DateCard();
        getContentPane().add(dateCard, "date");
        rentDetailsCard = new RentDetailsCard();
        getContentPane().add(rentDetailsCard, "rent");
        addCustomerCard = new AddCustomerDetailsCard();
        getContentPane().add(addCustomerCard, "addCustomerCard");
        editCustomerCard = new EditCustomerDetailsCard();
        getContentPane().add(editCustomerCard, "editCustomerCard");
        addTitleCard = new AddTitleCard();
        getContentPane().add(addTitleCard, "addTitle");
    ...
    private RentDetailsCard rentDetailsCard;
    private AddCustomerDetailsCard addCustomerCard;
    private EditCustomerDetailsCard editCustomerCard;
    private AddTitleCard addTitleCard;
